...
<div class="buttons2" >
    <ul>        
        ...
        <%-- <li><a href="/TiendaPOO2023/reportes/reporte_categoria.jsp" target="_blank">Ver Reporte</a></li> --%>
    </ul>
</div>            
<br/>
<div id="mensajes" 
...
<%
    ...
    String[][] Categoria = Operaciones.consultar(sql);
