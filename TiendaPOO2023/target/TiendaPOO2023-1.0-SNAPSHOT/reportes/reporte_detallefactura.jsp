...
<%
 ...
 File reportFile = new File(application.getRealPath("/reportes/Dfactura.jasper"));
 ...
 response.setHeader("Content-Disposition", "inline; filename=reporte_DetalleFactura.pdf");
