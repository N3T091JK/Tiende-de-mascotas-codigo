...
<%
 ...
 File reportFile = new File(application.getRealPath("/reportes/reporte_categoria.jasper"));

 //configuramos los parametros en una varible de tipo Map
 //que como un array
 Map parameters = new HashMap();
 //parameters.put("origen", "49");
 parameters.put ("filtro", "WHERE (idcategoria like '%"+valor1+"%' or categoria like '%"+valor1+"%')");
 ...
 response.setHeader("Content-Disposition", "inline; filename=reporte_categoria.pdf");
