...
<%
 ...
 File reportFile = new File(application.getRealPath("/reportes/ReporteEmpleado.jasper"));

 //configuramos los parametros en una varible de tipo Map
 //que como un array
 Map parameters = new HashMap();
 parameters.put("filtto", "SELECT nombres FROM empleado");
 ...
 response.setHeader("Content-Disposition", "inline; filename=reporte_empleado.pdf");
